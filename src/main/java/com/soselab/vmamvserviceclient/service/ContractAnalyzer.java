...
public class ContractAnalyzer {
    ...
    public List<VendorExtension> swaggerExtension(String filepath) throws IOException {
        String contractSource = readfile(filepath);
        //ObjectVendorExtension extension = new ObjectVendorExtension("x-contract");
        ObjectVendorExtension extension = getContractProperty(contractSource);

/*        if (contractProperty.getValue().size() != 0) {
            extension.addProperty(contractProperty);
        }*/
    ...
    private ObjectVendorExtension getContractProperty(String contractSource) {
        ...
        //System.out.println("contractContent: " + contractContent);
        ...
        for( int i = 1; i <= part1.length-1; i++ ) {
            ...
            if (url.getValue() != null) {
                if (description.getValue() != null) {
                    url.addProperty(description);
                }
                if (name.getValue() != null) {
                    url.addProperty(name);
                }
                if (request.getValue() != null) {
                    url.addProperty(request);
                }
                if (response.getValue() != null) {
                    url.addProperty(response);
                }
